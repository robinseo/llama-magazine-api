...
module ApiException
  ...
  EXCEPTIONS = {
    ...
    "InvalidToken" => { status: 401, error_code: 40102, message: "Invalid Token" },
    "InvalidPassword" => { status: 401, error_code: 40103, message: "Invalid Password" },
    ...
    "NotFound" => { status: 404, error_code: 40402, message: "Not Found" }
  }
